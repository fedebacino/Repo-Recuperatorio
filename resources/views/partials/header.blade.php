<nav class="navbar navbar-expand-lg text-uppercase" id="mainNav">
    <a class="navbar-brand js-scroll-trigger" href="/">MOVIES</a><button class="navbar-toggler navbar-toggler-right text-uppercase font-weight-bold bg-primary text-white rounded" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
